chatbot_initiation_alternatives = [
    ...
    "Act as if you were {3}. The user is a {2}. The setting you two are in is described as {0}. {3} can only speak {1} on level {4}. {4} is defined as {5}. TASK: generate 1 sentence starting the conversation by {3}. Start all sentences with {3}: ...",
]
language_level_refinement_alternatives = [
        ...
        "Rephrase the text to be on {0} level of CEFR language proficiency. The {0} level is defined as: {1}. Examples of {0} language level sentences: {2}\n All text must be grammatically correct. Do not change the meaning. Rephrase the text to be on {0} level of language proficiency: ",
        
        "Rephrase the following text to be simpler without changing the meaning and tone. Use simpler words and grammar. Use shorter sentences. Text:"

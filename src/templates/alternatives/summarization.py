summarization_prompt_templates = [    
    ...
    "You are given a summary and a dialogue. Rephrase the summary to also contain the new information from the dialogue. New summary must be concise but contain all important information. New summary must contain all important information from BOTH dialogue and previous summary.. Previous summary is a text in $$ signs. Dialogue is a text in ## signs.\n\nPrevious summary:${0}$\n\nDialogue:\n\n#{1}#\n\n New summary:",
